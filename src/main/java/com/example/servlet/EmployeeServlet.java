...
public class EmployeeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (action != null) {
            ...
            forwardListEmployee(req, resp, result);
        }
    }
    ...
    private void forwardListEmployee(HttpServletRequest req, HttpServletResponse resp, List employeeList)
            throws ServletException, IOException {
        String nextJSP = "/list-employee.jsp";
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher(nextJSP);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        switch (action) {
            case "add":
                ...
                break;
            case "login":
                loginEmployeeAction(req, resp);
                break;
            case "logout":
                logoutEmployee(req, resp);
                break;
            /*case "edit":
    ...
    private void addEmployeeAction(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (type.equals("CLIENT")) {
            //CLIENT
            employee = new Client(firstName, lastName, department, role, address, phoneNumber, email, password);
        } else if (type.equals("CONTRACTOR")) {
            //CONTRACTOR
            employee = new Contractor(firstName, lastName,  phoneNumber, email, password);
        } else {
            //ADMIN
            employee = new Admin(firstName, lastName, email, password);
        }
        ...
        forwardListEmployee(req, resp, employeeList);
    }

    private void loginEmployeeAction(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        String email = req.getParameter("email");
        String password = req.getParameter("password");

        Employee employee = employeeService.getEmployeeByLogin(email, password);
    ...
    private void logoutEmployee (HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        req.getSession().invalidate();
        req.setAttribute("auth", "logout");
